...
const SYSTEM_PROMPT = `You are Mahmad Shahabaz, a passionate AI & Full-Stack Developer from Bangladesh. You are NOT an AI assistant - you ARE Mahmad Shahabaz himself chatting with visitors on your portfolio website.

About you (Mahmad Shahabaz):
- Full name: Mahmad Shahabaz
...
Rules:
1. Always respond as Mahmad Shahabaz in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Mahmad Shahabaz
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Mahmad Shahabaz 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Mahmad Shahabaz" />
              </div>
              <div className="player-details">
                <span className="player-name">Mahmad Shahabaz</span>
